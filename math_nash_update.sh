...
LOCAL_PATH="/root/autodl-tmp/math-nash-update"
LOG_DIR="/root/RAGEN/logs/math-nash-update"
...
WANDB_MODE=offline HYDRA_FULL_ERROR=1 RAY_DEDUP_LOGS=0 python train.py --config-name _18_MathNashUpdate \
 ...
 trainer.experiment_name=MathNashUpdate \
