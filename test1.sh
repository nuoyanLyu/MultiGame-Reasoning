...
WANDB_MODE=offline python train.py --config-name _7_connect4 system.CUDA_VISIBLE_DEVICES=\"2,5\" trainer.n_gpus_per_node=2 actor_rollout_ref.rollout.tensor_model_parallel_size=2 trainer.experiment_name=connect4-grpo $USE_GRPO &
