...
WANDB_MODE=offline python train.py --config-name _7_connect4 system.CUDA_VISIBLE_DEVICES=\"0,1\" model_path=/root/autodl-tmp/Qwen3-1.7B trainer.default_local_dir=$LOCAL_PATH trainer.total_training_steps=100 trainer.n_gpus_per_node=2 actor_rollout_ref.rollout.tensor_model_parallel_size=2 trainer.experiment_name=connect4-grpo $USE_GRPO &
