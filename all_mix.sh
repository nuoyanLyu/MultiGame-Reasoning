...
LOCAL_PATH="/root/autodl-tmp/all-mix"
LOG_DIR="/root/RAGEN/logs/all-mix"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _20_all_mix \
 ...
 trainer.experiment_name=all-mix \
